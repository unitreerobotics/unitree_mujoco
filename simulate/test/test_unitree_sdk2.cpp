...
// {
//     const unitree_hg::msg::dds_::SportModeState_ *s = (const unitree_hg::msg::dds_::SportModeState_ *)msg;
...
int main()
{
    ...
    // ChannelSubscriber<unitree_hg::msg::dds_::SportModeState_> highstate_suber(TOPIC_HIGHSTATE);
